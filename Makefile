...
PRUNING_OBJECTS = $(addprefix ./build/objects/, pruning.o)
PRUANALYSE_OBJECTS = $(addprefix ./build/objects/, pruAnalyse.o)
OBJECTS := $(COMMON_OBJECTS) $(UTIL_OBJECTS) $(MAPPING_OBJECTS) $(MODEL_OBJECTS) $(PRUNING_OBJECTS) $(PRUANALYSE_OBJECTS)
# TEST_EXECS := $(addprefix ./build/, test0 test1)
SCRIPT_OBJECTS := $(addprefix ./build/,  place testPruning)
...
testPruning: ./mapping/script/testPruning.cpp $(OBJECTS)
	$(CXX) $(CXX_FLAGS) $< $(OBJECTS) -o ./build/$@
...
$(PRUNING_OBJECTS):./build/objects/%.o: ./pruning/src/%.cpp ./pruning/inc/%.h
	$(CXX) $(CXX_FLAGS) -c $< -o $@
	
$(PRUANALYSE_OBJECTS):./build/objects/%.o: ./pruning/src/%.cpp ./pruning/inc/%.h
	$(CXX) $(CXX_FLAGS) -c $< -o $@
